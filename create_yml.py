...
if __name__ == "__main__":
    ...
    configs['epochs'] = 60
    configs['lr'] = 3e-5
    configs['batch_size_exp2'] = 11                 # 2**(batch_size_exp) fb_max=13 wn_max=12
    configs['k'] = 5
    ...
    folder = 'configs/final_latent/'            # TODO change folder
    ...
    for dataset in ['fb15k', 'wn18rr']:
        for l in [10, 100, 1000]:
            configs['exp_name'] = '{}_{}_l{}'.format(model_name, dataset, int(l))  # Most important    '1' if configs['perm_inv'] else '0'
